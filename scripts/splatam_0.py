...
def initialize_new_params(new_pt_cld, mean3_sq_dist, gaussian_distribution, curr_data):
    ...
    params = {
        'means3D': means3D,
        'rgb_colors': new_pt_cld[:, 3:6][remain_indices_torch],
        'unnorm_rotations': unnorm_rots,
        'logit_opacities': logit_opacities,
        'log_scales': log_scales,
    }
...
def add_new_gaussians(params, variables, curr_data, sil_thres, 
    ...
    if torch.sum(non_presence_mask) > 0:
        ...
        new_params = initialize_new_params(new_pt_cld, mean3_sq_dist, gaussian_distribution, curr_data)
