...
def initialize_new_params(new_pt_cld, mean3_sq_dist, gaussian_distribution, 
                          last_w2c, curr_w2c, pixelsplat, curr_data, all_cld, render_error,
                          params_copy):
    global interval_
    interval_ += 1
    ...
    print(render_error)
    print("~~~~~~~~~~~~~~~~")
    if render_error > 2000 and curr_data['id'] >= 200 and interval_ >= 200:
...
def add_new_gaussians(params, variables, curr_data, sil_thres, 
    ...
    if torch.sum(non_presence_mask) > 0:
        ...
        new_params, pix_ = initialize_new_params(new_pt_cld, mean3_sq_dist, gaussian_distribution, 
                                           last_w2c, curr_w2c, pixelsplat, curr_data, all_cld, error_sum,
                                           params.copy())
